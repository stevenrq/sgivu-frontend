...
describe('serviceHealthInterceptor', () => {
  ...
  let serviceHealth: MockedObject<ServiceHealthService>;

  beforeEach(() => {
    serviceHealth = {
      markGatewayDown: vi.fn().mockName('ServiceHealthService.markGatewayDown'),
      markGatewayUp: vi.fn().mockName('ServiceHealthService.markGatewayUp'),
      markAuthDown: vi.fn().mockName('ServiceHealthService.markAuthDown'),
      markAuthUp: vi.fn().mockName('ServiceHealthService.markAuthUp'),
    } as unknown as MockedObject<ServiceHealthService>;
