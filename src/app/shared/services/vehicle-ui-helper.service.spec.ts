...
describe('VehicleUiHelperService', () => {
  ...
  beforeEach(() => {
    carServiceSpy = {
      changeStatus: vi.fn().mockName('CarService.changeStatus'),
    } as unknown as MockedObject<CarService>;
    motorcycleServiceSpy = {
      changeStatus: vi.fn().mockName('MotorcycleService.changeStatus'),
  ...
  describe('updateCarStatus()', () => {
    beforeEach(() => {
      carServiceSpy.changeStatus.mockClear();
    });

    it('debe generar descripción sin plate: "el automóvil seleccionado"', () => {
      const onSuccessSpy = vi.fn();
      carServiceSpy.changeStatus.mockReturnValue(of({} as any));
    ...
    it('debe mostrar diálogo de error y no ejecutar onSuccess cuando hay error', async () => {
      const onSuccessSpy = vi.fn();
      carServiceSpy.changeStatus.mockReturnValue(
  ...
  describe('updateMotorcycleStatus()', () => {
    beforeEach(() => {
      motorcycleServiceSpy.changeStatus.mockClear();
    });

    it('debe generar descripción sin plate: "la motocicleta seleccionada"', () => {
      const onSuccessSpy = vi.fn();
      motorcycleServiceSpy.changeStatus.mockReturnValue(of({} as any));
    ...
    it('debe mostrar diálogo de error y no ejecutar onSuccess cuando hay error', async () => {
      const onSuccessSpy = vi.fn();
      motorcycleServiceSpy.changeStatus.mockReturnValue(
        throwError(() => new Error('Update failed')),
      );
