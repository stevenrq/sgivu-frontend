...
describe('CarService', () => {
  ...
  describe('update()', () => {
    ...
    it('Debe no cambiar el estado ante error del servidor', async () => {
  ...
  describe('changeStatus()', () => {
    ...
    it('Debe manejar error de cambio de estado correctamente', async () => {
      const initial = [buildCar({ id: 1, status: VehicleStatus.AVAILABLE })];
      service.getState().set(initial as any);
