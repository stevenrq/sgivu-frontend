...
description: Generates Angular code and provides architectural guidance. Trigger when creating projects, components, or services, or for best practices on reactivity (signals, linkedSignal, resource), forms, dependency injection, routing, SSR, accessibility (ARIA), animations, styling (component styles, Bootstrap), testing, or CLI tooling.
license: MIT
metadata:
...
- **Using Bootstrap with Angular**: Integrating Bootstrap 5 into Angular projects. Read [bootstrap.md](references/bootstrap.md)
